...
- [ ] **AUTH-05**: User completes onboarding flow capturing household size and dietary preferences (2-3 screens)

### Ingredient Selection

- [ ] **INGR-01**: User can search ingredients from external API with autocomplete
- [ ] **INGR-02**: User can browse ingredients by category
- [ ] **INGR-03**: User can add ingredients to favorites for quick access
- [ ] **INGR-04**: User can filter ingredients by dietary restrictions (vegetarian, vegan, gluten-free, dairy-free)
- [ ] **INGR-05**: User can select "I have these ingredients today" for recipe discovery

### Recipe Discovery & Generation

- [ ] **RECP-01**: User can browse recipes from external API with search by name, ingredient, cuisine, and cook time
- [ ] **RECP-02**: User can view recipe details including ingredients list, step-by-step instructions, cook time, and servings
- [ ] **RECP-03**: User can scale recipe serving size and see adjusted ingredient quantities
- [ ] **RECP-04**: User can discover recipes based on selected available ingredients ("use what you have")
