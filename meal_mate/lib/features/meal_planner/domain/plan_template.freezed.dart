...
class _PlanTemplate implements PlanTemplate {
  const _PlanTemplate({required this.id, required this.name, required this.createdAt, final  List<MealSlot> slots = const []}): _slots = slots;
...
@override@JsonKey() List<MealSlot> get slots {
