...
abstract class $OnboardingDataCopyWith<$Res> {
  ...
  @useResult
  $Res call({int householdSize, List<String> dietaryPreferences});
}
...
class _$OnboardingDataImpl implements _OnboardingData {
  ...
  @override
  String toString() {
    return 'OnboardingData(householdSize: $householdSize, dietaryPreferences: $dietaryPreferences)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, householdSize,
  ...
  _$$OnboardingDataImplCopyWith<_$OnboardingDataImpl> get copyWith =>
      __$$OnboardingDataImplCopyWithImpl<_$OnboardingDataImpl>(this, _$identity);
}

abstract class _OnboardingData implements OnboardingData {
  const factory _OnboardingData(
      {final int householdSize,
      final List<String> dietaryPreferences}) = _$OnboardingDataImpl;
